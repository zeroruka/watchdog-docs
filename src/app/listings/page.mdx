...
## List all listings {{ tag: 'GET', label: '/api/listings/' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/listings/">

    ```bash {{ title: 'cURL' }}
    curl -G https://api.watchdog.moe/api/listings/ \
...
## List a single listing {{ tag: 'GET', label: '/api/listings?listing_id={id}' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/listings?listing_id={id}">

    ```bash {{ title: 'cURL' }}
    curl -G https://api.watchdog.moe/api/listings?listing_id={id} \
      -H "Authorization: Bearer {token}" \
    ```
    </CodeGroup>
...
## Delete all listings {{ tag: 'DELETE', label: '/api/listings/' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="DELETE" label="/api/listings/">

    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.watchdog.moe/api/listings/ \
      -H "Authorization: Bearer {token}" \
    ```
    </CodeGroup>
