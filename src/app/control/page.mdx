...
## Get scraper status {{ tag: 'GET', label: '/api/control/status/' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/control/status/">

    ```bash {{ title: 'cURL' }}
    curl -G https://api.watchdog.moe/api/control/status/ \
...
## Start scraper {{ tag: 'POST', label: '/api/control/start' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/api/control/start/">

    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.watchdog.moe/api/control/start/ \
      -H "Authorization: Bearer {token}"
    ```
...
## Stop scraper {{ tag: 'POST', label: '/api/control/stop' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/api/control/stop/">

    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.watchdog.moe/api/control/stop/ \
      -H "Authorization: Bearer {token}"
    ```
