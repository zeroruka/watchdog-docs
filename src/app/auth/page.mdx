export const metadata = {
  title: 'Auth',
  description:
    'On this page, we’ll dive into the different auth endpoints you can use to manage login states.',
}
...
## Register a new user {{ tag: 'POST', label: '/v1/register/' }}
...
## Login to an existing user account {{ tag: 'POST', label: '/v1/login/' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/v1/login/">
...
## Change password {{ tag: 'POST', label: '/v1/change-password/' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/v1/change-password/">
